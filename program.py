...
class Instabot():
    ...
    def __init__(self,username,password):
        ...
        self.driver = webdriver.Chrome("chromedriver.exe") #this is the path of webdriver, here I used geckodriver-linux since I am using Firefox in linux. Change the path of webdriver according to your environment
